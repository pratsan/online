...
public class UserServiceTest {
 ...
 public void init()
 {
    ...
    @Test public void userLoginTest() {
...
assertEquals(responseDto.getStatusCode(), res.getStatusCode());
    ...
    @Test public void InvalidUserLoginTest() {
    ...
    @Test public void InvalidUserLoginUserTest() {
    ...
    @Test public void InvalidUserLogiPasswordTest() {
    ...
    @Test public void NoUserLoginTest() {
   	 ...
   	 user.setPassword("pal");
   	 user.setPhoneNumber("1234");
   	 Mockito.when(userRepository.findByEmailAndPassword("pal", "pal"))
   		.thenReturn(user);
   	ResponseDto res=userServiceImpl.userLogin(userDto);
   	assertEquals(responseDto.getStatusCode(), res.getStatusCode());
